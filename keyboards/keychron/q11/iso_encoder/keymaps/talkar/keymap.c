...
*/
   ...
   [DEV_BASE] = LAYOUT_92_iso(
        QK_BOOT,  KC_CAPS,    KC_F1,      KC_F2,    KC_F3,   KC_F4,    KC_F5,     KC_F6,                    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_INS,   KC_DEL,   QK_BOOT,
        _______,  MO(DEV_FN), KC_1,       KC_2,     KC_3,    KC_4,     KC_5,      KC_6,                     KC_7,     KC_8,     KC_9,     KC_0,    KC_MINS,     KC_EQL,   KC_BSPC,            KC_PGUP,
        _______,  KC_TAB,     KC_Q,       KC_W,     KC_J,    KC_R,     KC_T,                                KC_Y,     KC_U,     KC_I,     KC_O,     KC_P, KC_LBRC,    KC_RBRC,         KC_PGDN,
        _______,  KC_ESC,     KC_A,       KC_S,     KC_D,    KC_F,     KC_G,                                KC_H,     KC_N,     KC_E,     KC_L,     LSFT(KC_COMM),   KC_SCLN, KC_QUOT, KC_ENT,           KC_HOME,
        _______,  KC_LSFT,    KC_NUBS,    KC_Z,     KC_X,    KC_C,     KC_V,     KC_B,                      KC_K,     KC_M,  KC_COMM,   KC_DOT,   KC_SLSH,           LSFT(KC_COMM),  KC_UP,
